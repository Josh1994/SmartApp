...
public class RouteFinder {
    ...
    /**
     *  Key - NZ cities which are the start of intl Air routes
     * @return
     */
    ...
    /**
     * Key - NZ cities which are the start of intl Surface routes
     * @return
     */
    ...
    private void getAllRoutes() {
        ...
        for (TransportCostUpdate tcu : stages) {
            ...
            if (tcu.getType().equals(Event.DOMESTIC)) {
    ...
    private boolean findMatch(String nextOrigin, String priority, TransportCostUpdate tcu){
            ...
            if (tcu.getOrigin().equals(nextOrigin) && tcu.getType().equals(priority)) {
                return true;
            }
            ...
            // The priority queue will always guarantee the cheapest cost
                    ...
                    && !tcu.getType().equals(Event.DOMESTIC) && tcu.getOrigin().equals(nextOrigin)) {
                return true;
            }
